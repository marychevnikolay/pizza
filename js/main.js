...
const products = (data) => {
    ...
    for (let key in sets) {
        ...
        document.querySelector(".sets-products").html(newElement);
    ...
    for (let key in rolls) {
       ...
       document.querySelector(".rolls-products").html(newElement);
    }
    ...
    for (let key in pizza) {
       ...
       document.querySelector(".pizza-products").html(newElement);
    }
    newElement = "";
    for (let key in wok) {
       ...
       document.querySelector(".wok-products").html(newElement);
    }
}
...
const createElement = (id, name, foodValue, price, image, sauce, priceSauce, counter, popular, vegetarian, newDish, spicy) => {
